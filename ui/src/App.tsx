  ...
  if (healthQuery.error) {
    return (
      <div className="mx-auto max-w-xl py-10 text-sm text-destructive">
        {healthQuery.error instanceof Error ? healthQuery.error.message : t("app.failedLoadState")}
      </div>
    );
  }
...
function OnboardingRoutePage() {
  ...
  const description = matchedCompany
    ? t("app.onboardingAddAgentDescription")
    : companies.length > 0
      ? t("app.onboardingCreateAnotherDescription")
      : t("app.onboardingCreateFirstDescription");
